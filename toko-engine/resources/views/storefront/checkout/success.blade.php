<x-layouts::storefront title="Order berhasil">
    <section class="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-24">
        <x-ui.card class="text-center"><span class="mx-auto flex size-16 items-center justify-center rounded-full bg-tosca-tint text-tosca"><svg class="size-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" aria-hidden="true"><path d="m5 12 4 4L19 6"/></svg></span><x-ui.badge variant="orange" class="mt-6">Order tercatat</x-ui.badge><h1 class="mt-4 text-4xl text-navy">Terima kasih!</h1><p class="mt-3 text-ink-soft">Nomor order <strong class="text-navy">{{ $order->number }}</strong></p>
